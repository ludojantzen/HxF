...
case_name = 'HTR-10_long' # Name of the input folder  A CHANGER
...
#%% Burnup cycle
threshold_type = 'burnup' #'551370'
threshold = 72 #* 1.47885E-06
...
#%% Outputing
output_folder_name = 'HTR-10_ctherm_restart' # Name of the output folder
verbosity_mode = 0
...
if restart_calculation:
    restart_step = 1000
    restart_data = '/global/scratch/users/ludovicjantzen/HxF/Cases/HTR-10_ctherm/Data/core_1000.csv'
    restart_binary = '/global/scratch/users/ludovicjantzen/HxF/Cases/HTR-10_ctherm/wrk_Serpent/input.inp.wrk_1000'
